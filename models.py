...
class ResNet(nn.Module):
	...
	def __init__(self, block, list_of_num_layers, list_of_out_dims, flatten = False):          #list_of_num_layers = [2,2,2,2]  ; list_of_out_dims = [64,128,256,512]
...
def ResNet18(flatten=False):
	return ResNet(SimpleBlock, [2, 2, 2, 1], [64, 128, 256, 512], flatten)
	#return ResNet(BottleneckBlock, [3,4], [256,512], flatten)
...
def VggNet(pretrained=False, **kwargs):
    ...
    model = make_layers(cfg['D1'], dilation=dilation['D1'])
    if pretrained:
